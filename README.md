...
Cloudinary credentials are server-only. Menu images are previewed locally, uploaded during menu-item save, and tracked by Cloudinary public ID so replaced images can be removed safely.
